...
function getChromiumPath() {
    ...
    const findSystemBinary = (candidateNames) => {
    ...
    if (!fs.existsSync(basePath)) {
        if (process.platform === 'linux') {
            return findSystemBinary(['chromium', 'chromium-browser', 'google-chrome', 'google-chrome-stable']);
        }
        return null;
    }
    ...
    if (process.platform === 'linux') {
        return findFile(basePath, 'chrome') || findSystemBinary(['chromium', 'chromium-browser', 'google-chrome', 'google-chrome-stable']);
    }
    // Windows
